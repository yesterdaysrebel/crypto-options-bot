...
from bot.risk.window import india_options_session_close_utc, within_minutes_of_ist_time
...
def test_india_session_close_is_1730_ist() -> None:
    now = dt.datetime(2026, 5, 15, 4, 0, 0)  # 09:30 IST
    close = india_options_session_close_utc(now)
    assert close == dt.datetime(2026, 5, 15, 12, 0, 0)  # 17:30 IST
